...
// @Component({
//   selector: 'app-workouts', // Assuming this is your component's selector
//   templateUrl: './workouts.component.html',
//   styleUrls: ['./workouts.component.css'],
//   standalone: true, // If this component is standalone
//   imports: [CommonModule, RouterLink] // Import necessary modules if standalone
// })
// export class WorkoutsComponent implements OnInit {
//   workouts: any[] = []; // Array to hold the workouts fetched from the API
//   errorMessage: string = '';
...
//       (response) => { // Rename 'data' to 'response' for clarity with the API structure
//         console.log('API response received:', response);
//         this.workouts = response.items; // Extract the 'items' array
//         console.log('Workouts array updated:', this.workouts);
//       },
//       (error) => {
//         this.errorMessage = 'Failed to load workouts.';
//         console.error('Error loading workouts:', error);
//         console.log('Current workouts array (on error):', this.workouts);
//       }
//     );
//   }
...
export class WorkoutsComponent implements OnInit {
  ...
  // Navigation methods remain in WorkoutsComponent
  navigateToWorkoutDetails(workoutId: any): void {
    this.router.navigate(['/workout-details', workoutId]);
  }
