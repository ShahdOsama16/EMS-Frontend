...
export const routes: Routes = [
    ...
    {path:'fitness-info',component:FitnessInfoComponent, canActivate:[myGuardGuard]},
    ...
    {path:"yoga",component:YogaComponent,canActivate:[myGuardGuard]},
    {path:"zumba",component:ZumbaComponent,canActivate:[myGuardGuard]},
    {path:"aerobics",component:AerobicsComponent,canActivate:[myGuardGuard]},
    {path:"fitness",component:FitnessComponent,canActivate:[myGuardGuard]},
    {path:"boxing",component:BoxingComponent,canActivate:[myGuardGuard]},
